...
#Script_Name: Ninja Deploy - Bitwarden
#Desc: NinjaRMM (NinjaOne) Silent Software Installer for Bitwarden
...
$AppName = "Bitwarden";          $AppDir = "Bitwarden";          
$PackageHash = "";
$64bitPackage_URL = "https://vault.bitwarden.com/download/?app=desktop&platform=windows"
$64bitPackageName = "Bitwarden-Installer-2022.9.1.exe";
$32bitPackage_URL = "https://vault.bitwarden.com/download/?app=desktop&platform=windows"
$32bitPackageName = "Bitwarden-Installer-2022.9.1";
